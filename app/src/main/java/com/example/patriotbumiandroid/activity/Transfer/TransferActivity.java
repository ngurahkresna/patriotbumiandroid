package com.example.patriotbumiandroid.activity.Transfer;
...
public class TransferActivity extends AppCompatActivity {
    ...
    private LinearLayout mandiriTransfer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mandiriTransfer = findViewById(R.id.mandiriTransfer);
...
//                                holder.progressBar.setVisibility(View.GONE);
        ...
        mandiriTransfer.setOnClickListener(new View.OnClickListener() {
            @Override
