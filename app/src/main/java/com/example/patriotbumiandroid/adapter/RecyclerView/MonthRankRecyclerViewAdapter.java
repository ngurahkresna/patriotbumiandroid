...
public class MonthRankRecyclerViewAdapter extends RecyclerView.Adapter<MonthRankRecyclerViewAdapter.ViewHolder> {
    ...
    public MonthRankRecyclerViewAdapter(String[] myDataSet, String[] myDataSetXp) {
        mDataSet = myDataSet;
    ...
    @NonNull
    @Override
    public MonthRankRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
